// pages/events/EventCreate.js
import React, { useState } from 'react';
import eventService from '../../services/events/eventService';
import './EventCreate.css';

const EventCreate = ({ onBack, onSuccess }) => {
  ...
  const validateForm = () => {
    ...
    // Remove all other date validations
  ...
  // In your EventCreate.js handleSubmit function, update the error handling:
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (error.type === 'timeout') {
      setError('Request timed out. Please check if the event was created successfully before trying again.');
      ...
      <div className="event-create-header">
        <div className="header-content">
          <div className="header-info">
            ...
            <p className="header-subtitle">Share your lacrosse expertise with the community</p>
          </div>
